  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-9  col-sm-6">
        <div class="image-wrapper  blog-single-post__image-wrapper" href="#">
          <img class="image" src="images/blog/single-post/post-1.jpg" alt="">
        </div>

        <section class="blog-single-post__desc">
          <h1>Celebrate National Hot Tea Month This January</h1>
          ...
          <h2>Sample a New Tea Variety</h2>
          <p>
          ...
          Tegs:
          <span class="label label-default">National Hot Tea</span>
          <span class="label label-default">Flavored teas</span>
          <span class="label label-default">Hot tea types</span>
        </section>

        <section class=""blog-single-post__comments">
          <b>Comments</b>

        <?php for ($bcom = 1; $bcom <= 2; ++$bcom ): ?>
          <div class="media">
            <div class="media-left">
              <a class="image-wrapper  blog-single-post__comment-image-wrapper" href="#">
                <img class="image" src="images/blog/single-post/comments/comment-<?php echo $bcom; ?>.jpg" alt="">
              </a>
            </div>
            <div class="media-body">
              <h4 class="media-heading">Julli</h4>
              <span>20 January 2017</span>
              <p>
                I have mentioned this neat tea product on the blog once before. I used mine every single day during the holidays and every time I served someone a tea with one of the tea bling clipped onto the tea bag, they would just got on and on about how gosh darn cool it was! They are certainly a conversation piece and they really do add a little sparkle to your tea party. Recently, I have been clipping other fresh herbs to the clip with a tea bag to spice things up when I feel like it. I love having that option with this tea product, too.
              </p>
              <a href="#">
                <svg class="allign-middle" width="15" height="15" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
                ...
                <span class="allign-middle">Repost</span>
              </a>
              <a href="#">
                <svg class="allign-middle" width="15" height="15" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
        ...
        <section class="blog-single-post__pager"><!--pager (begin)-->
          <nav aria-label="...">
            <ul class="pager">
              <li class="previous">
                <a class="blog-single-post__prev-post-link" href="#">
                  <svg class="allign-middle" width="15" height="15" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
              ...
              <li class="next">
                <a class="blog-single-post__next-post-link" href="#">
