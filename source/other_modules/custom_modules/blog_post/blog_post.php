  <div class="row">
    <div class="col-sm-6">
      <a class="image-wrapper  <?php echo $blog_post_data -> blog_post_data['class__image-wrapper']; ?>" href="#">
        <img class="image" src="<?php echo $blog_post_data -> blog_post_data['img-src'] .'post-'.$ba; ?>.jpg" alt="">
      </a>
    </div>

    <div class="col-sm-6">
      <div class="blog___post-desc">
        <h3 class="">
          <a class="" href="#"><?php echo $blog_post_data -> blog_post_data['title-of-block']; ?></a>
        </h3>
        ...
        <div class="">
          ...
          <div class="  text-right">
            <a href="#">
              ...
              <svg class="allign-middle" width="20" height="20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 1000 1000" enable-background="new 0 0 1000 1000" xml:space="preserve" fill="#e56a6a">
                          <g><path d="M10,10.2L990,500L10,989.8V10.2z"/></g>
                        </svg>
            </a>
          </div>
        </div>
