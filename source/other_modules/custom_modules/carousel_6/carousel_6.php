    ...
    <div class="carousel-wrapper">
        ...
        <?php for ($at = 1; $at <= 8; ++$at): ?>
          <li class="item carousel-6__container-item">
            ...
            <div class="image-wrapper  carousel-6__image-wrapper">
              <img class="image--responsive" src="<?php echo ( $carousel_6_data -> carousel_6_data['img-src']) .'about-us-'. $at .'.jpg'; ?>" alt="carousel-6-image">
            </div>
      ...
      <div class="carousel-6__navigation  hidden-sm  hidden-xs">
        <a class="links  btn  carousel-navigation__prev" id="carousel-6__navigation-prev<?php echo $carousel_6_data -> carousel_6_data['suffix']; ?>" role="button">
        ...
        <a class="links  btn  carousel-navigation__next" id="carousel-6__navigation-next<?php echo $carousel_6_data -> carousel_6_data['suffix']; ?>" role="button">
          <svg class="carousel-navigation__icon" width="20" height="20" viewBox="0 0 1000 1000" >
