<section class="carousel-1">
  <div class="container" style="padding: 0;">
    ...
    <div class="carousel-1__navigation  hidden-sm  hidden-xs">
      <a class="links  " id="carousel-1__navigation-prev<?php echo $carousel_1_data -> carousel_1['suffix']; ?>" role="button">
        <svg width="20" height="20" viewBox="0 0 1000 1000" >
          <path class="icons__svg-color" d="M793.8,10v980L206.2,500L793.8,10z"/>
        </svg>
      </a>
      <a class="links  " id="carousel-1__navigation-next<?php echo $carousel_1_data -> carousel_1['suffix']; ?>" role="button">
        <svg width="20" height="20" viewBox="0 0 1000 1000" >
