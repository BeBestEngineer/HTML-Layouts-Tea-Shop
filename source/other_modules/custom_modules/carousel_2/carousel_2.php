<section class="carousel-2">
  <div class="container" style="padding: 0;">
    ...
    <div class="carousel-2__navigation  hidden-sm  hidden-xs">
      <a class="links  " id="carousel-2__navigation-prev<?php echo $carousel_2_data -> carousel_2['suffix']; ?>" role="button">
        <svg width="20" height="20" viewBox="0 0 1000 1000">
          <path class="icons__svg-color" d="M793.8,10v980L206.2,500L793.8,10z"/>
        </svg>
      </a>
      <a class="links  " id="carousel-2__navigation-next<?php echo $carousel_2_data -> carousel_2['suffix']; ?>" role="button">
        <svg width="20" height="20" viewBox="0 0 1000 1000">
