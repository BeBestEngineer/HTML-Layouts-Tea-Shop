<aside class="aside-blog">
  ...
  <section class="aside-blog__section  recent-posts">
    <?php require_once 'other_modules/custom_modules/recent_posts_1/recent_posts_1.php'; ?>
  </section>


  <section class="aside-blog__section  recent-comments">
    <?php require_once 'other_modules/custom_modules/recent_comments_1/recent_comments_1.php'; ?>
  </section>
